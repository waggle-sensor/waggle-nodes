...
echo "7e558fe06b0ff1ed39fa0ea5157e5a6c1374ef3d413936f8094c56942e7defaf  /tmp/waggle_epoch.sh" | sha256sum -c
if [ $? == 0 ]; then
    ...
    echo "7e558fe06b0ff1ed39fa0ea5157e5a6c1374ef3d413936f8094c56942e7defaf  /usr/lib/waggle/nodecontroller/scripts/waggle_epoch.sh" | sha256sum -c
    if [ $? == 0 ]; then
        echo ""
...
if [ $? == 0 ]; then
    ...
    echo "7e558fe06b0ff1ed39fa0ea5157e5a6c1374ef3d413936f8094c56942e7defaf  ${OTHER_DISK_P2}/usr/lib/waggle/nodecontroller/scripts/waggle_epoch.sh" | sha256sum -c
    if [ $? == 0 ]; then
        echo ""
